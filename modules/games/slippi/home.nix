...

{
  home.packages = [
    (let
      ...
      version = "v3.1.0";
      hash =
        "039qm941xbl97zvvv0q6480fps4w1a0n71sk1wiacs6n4gm2bs6f"; # nix-prefetch-url https://github.com/project-slippi/Ishiiruka/releases/download/v3.1.0/Slippi_Online-x86_64.AppImage
