...
in
{
  environment.etc."${steamDir}/GarrysMod/garrysmod/cfg/autoexec.cfg".text = ''
  ...
  environment.etc."${steamDir}/GarrysMod/garrysmod/cfg/movement_reload.cfg".text = ''
    bind r +reload; bind KP_END "exec movement_restart"
  '';
  environment.etc."${steamDir}/GarrysMod/garrysmod/cfg/movement_restart.cfg".text = ''
    bind r "say !r"; bind KP_END "exec movement_reload"
  '';

  # Switch between mwheel jump and mwheel scroll inv (numpad 2)
  environment.etc."${steamDir}/GarrysMod/garrysmod/cfg/mwheel_jump.cfg".text = ''
    bind mwheelup +jump; bind mwheeldown +jump; bind KP_DOWNARROW "exec mwheel_inv"
  '';
  environment.etc."${steamDir}/GarrysMod/garrysmod/cfg/mwheel_inv.cfg".text = ''
  ...
  environment.etc."${steamDir}/GarrysMod/garrysmod/cfg/mouse_buttons_turn.cfg".text = ''
    bind mouse4 +left; bind mouse5 +right; bind KP_PGDN "exec mouse_buttons_lean"
  '';
  environment.etc."${steamDir}/GarrysMod/garrysmod/cfg/mouse_buttons_lean.cfg".text = ''
    bind mouse4 +leanleft; bind mouse5 +leanright; bind KP_PGDN "exec mouse_buttons_turn"
  '';

  # Hide and show chat
  environment.etc."${steamDir}/GarrysMod/garrysmod/cfg/hide_chat.cfg".text = ''
    hud_saytext_time 0; bind = "exec show_chat"
  '';
  environment.etc."${steamDir}/GarrysMod/garrysmod/cfg/show_chat.cfg".text = ''
