...
buildGoModule (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "mikegillan";
    repo = "rclone";
    rev = "394d754ab3cf85d2beead3f1595264962dceb165";
    hash = "sha256-VQVEv85RiUnRpfHXU68cZ6F86b/44piwsKIYH64dEpI=";
  };

  vendorHash = "sha256-1OpUiyA3qbfcNMZ25FlVZoHgs9JMcPzpN+4f/XS999M=";
